...
<div class="container px-6 py-8 mx-auto">
    ...
    <div class="mb-6 animate-fade-in flex flex-col md:flex-row md:items-center md:justify-between bg-gradient-to-r from-white to-gray-50 p-6 rounded-xl shadow-md border border-gray-100" style="animation-delay: 0.1s">
        ...
        <div class="mt-4 md:mt-0 space-x-2 flex">
            <a href="<?php echo e(route('guru.profile.edit')); ?>" class="px-4 py-2 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 rounded-md text-white text-sm font-medium inline-flex items-center transition-colors shadow-sm hover:shadow-md">
                <i class="fas fa-pencil-alt mr-2"></i>
                Edit Profil
            </a>
            <a href="<?php echo e(route('guru.settings.index')); ?>" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-md text-gray-700 text-sm font-medium inline-flex items-center transition-colors shadow-sm hover:shadow-md">
    ...
    <div class="animate-fade-in mb-6" style="animation-delay: 0.25s">
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl shadow-sm border border-blue-100">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm text-blue-700">
                            <?php if(isset($user->teacher->profile_completed) && $user->teacher->profile_completed): ?>
                ...
                <div>                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e(isset($user->teacher->profile_completed) && $user->teacher->profile_completed ? 'bg-green-100 text-green-800' : 'bg-amber-100 text-amber-800'); ?>">
                        <?php if(isset($user->teacher->profile_completed) && $user->teacher->profile_completed): ?>
        ...
        <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
                    ...
                    <div class="bg-gradient-to-r from-indigo-600 to-blue-500 text-white p-8 relative overflow-hidden">
                        ...
                        <div class="relative flex flex-col items-center justify-center z-10">
                                ...
                                <div class="relative w-full h-full rounded-full border-4 border-white shadow-md overflow-hidden group">
                                    <?php if($user->avatar): ?>
                                        <img class="w-full h-full object-cover lazy-load" loading="lazy"
                                            src="<?php echo e(asset('storage/' . $user->avatar)); ?>" alt="<?php echo e($user->name); ?>">
                                    <?php else: ?>
                                    ...
                                    <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity duration-300">
                                        <a href="<?php echo e(route('guru.profile.edit')); ?>" class="bg-white/30 backdrop-blur-sm text-white text-sm py-1 px-3 rounded-full hover:bg-white/50 transition-colors">
                            ...
                            <!-- Name and Role -->
                            <h3 class="text-2xl font-bold text-white mb-1"><?php echo e($user->name); ?></h3>
                            <div class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white/20 backdrop-blur-sm text-white mb-3 pulse-animation">
                                ...
                                <?php echo e($user->role->name ?? 'Guru'); ?>

                            </div>
                            
                            <!-- NIP Badge if available -->
                            <?php if(isset($user->teacher) && $user->teacher && isset($user->teacher->nip)): ?>
                    ...
                    <div class="p-6">
                        <div class="space-y-5">
                            <div class="flex items-center hover-translate">
                              ...
                              <div class="flex items-center hover-translate">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="font-medium text-gray-800"><?php echo e($user->username); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center hover-translate">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="font-medium text-gray-800"><?php echo e($user->created_at ? $user->created_at->translatedFormat('d F Y') : 'N/A'); ?></p>
                                </div>
                            </div>
                            
                            <?php if(isset($user->teacher) && $user->teacher && isset($user->teacher->phone)): ?>
                            <div class="flex items-center hover-translate">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="font-medium text-gray-800"><?php echo e($user->teacher->phone); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mt-8 space-y-3">
                            <a href="<?php echo e(route('guru.profile.edit')); ?>" class="w-full py-3 px-4 bg-gradient-to-r from-indigo-600 to-blue-500 hover:from-indigo-700 hover:to-blue-600 text-white font-medium rounded-lg shadow-sm hover:shadow-md text-center transition-all duration-200 inline-flex items-center justify-center space-x-2">
            ...
            <div class="lg:col-span-8 space-y-8">            <!-- Teaching Information -->
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>                            <h4 class="text-base font-medium text-gray-700 mb-4 flex items-center">
                                ...
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <?php if(isset($user->teacher) && method_exists($user->teacher, 'subjects')): ?>
                                        <?php $__empty_1 = true; $__currentLoopData = $user->teacher->subjects()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div>
                                ...
                                <div>
                                    <?php if(isset($user->teacher) && method_exists($user->teacher, 'classrooms')): ?>
                                        <?php $__empty_1 = true; $__currentLoopData = $user->teacher->classrooms()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classroom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>                                        <div class="bg-gradient-to-r from-green-50 to-teal-50 mb-2 rounded-lg p-3 border border-green-100 hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 transform">
                                        ...
                                        <i class="fas fa-users"></i>
                                                    ...
                                                    <div class="flex-grow">
                                                        <h5 class="font-medium text-gray-800"><?php echo e($classroom->name); ?></h5>
                                                        <div class="flex items-center justify-between">
                                                            <p class="text-sm text-gray-500"><?php echo e($classroom->students_count ?? '0'); ?> Siswa</p>
                ...
                <div class="animate-fade-in" style="animation-delay: 0.5s">
                    <div class="bg-gradient-to-r from-teal-50 to-green-50 rounded-xl shadow-md border border-teal-100 overflow-hidden hover:shadow-lg transition-all duration-300 border-pulse">
                        ...
                        <div class="p-6">                            <?php if(isset($todaySchedules) && $todaySchedules->count() > 0): ?>
                                <div class="space-y-4">
                                            ...
                                            <div class="flex-grow">
                                                <div class="flex items-center justify-between">
                                                    <h5 class="text-sm font-medium text-gray-800">
                                                        <?php echo e($schedule->subject->name ?? 'Mata Pelajaran'); ?>
                                                ...
                                                <p class="text-xs text-gray-500 mt-1">
                                                    Kelas <?php echo e($schedule->classroom->name ?? 'Belum ditetapkan'); ?>
                            ...
                            <a href="<?php echo e(route('guru.schedule.index')); ?>" class="inline-flex items-center px-4 py-2 text-sm text-teal-700 hover:text-teal-800 transition-colors">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <?php if(isset($user->teacher) && isset($user->teacher->phone)): ?>
                        <div class="flex items-center text-sm">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700"><?php echo e($user->teacher->phone ?? 'Belum diisi'); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <?php if(isset($user->teacher) && isset($user->teacher->address)): ?>
                        <div class="flex items-center text-sm">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700"><?php echo e($user->teacher->address ?? 'Belum diisi'); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center text-sm">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700"><?php echo e($user->teacher->education ?? 'S1 Pendidikan'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700"><?php echo e($user->teacher->specialization ?? 'Belum diisi'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="flex items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-gray-800">
                                            <?php if(isset($user->teacher) && isset($user->teacher->teaching_hours)): ?>
                                                <?php echo e($user->teacher->teaching_hours); ?>
                            ...
                            <div class="stat-card bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-300">
                                <div class="flex items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-gray-800">
                                            <?php if(isset($user->teacher) && method_exists($user->teacher, 'materials')): ?>
                                                <?php echo e($user->teacher->materials()->count()); ?>
                            ...
                            <div class="stat-card bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-300">
                                <div class="flex items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-2xl font-bold text-gray-800">
                                            <?php if(isset($user->teacher) && isset($user->teacher->student_engagement)): ?>
                                                <?php echo e($user->teacher->student_engagement); ?>%
                                            <?php else: ?>
                                                87%
                                            <?php endif; ?>
                                        </p>
            ...
            <!-- Change Password Section -->            <div class="animate-fade-in" style="animation-delay: 0.7s">
                    <div class="bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 border-pulse">
                        ...
                        <div class="p-6">
                            <form action="<?php echo e(route('guru.profile.update-password')); ?>" method="POST" class="space-y-4">
                                <?php echo csrf_field(); ?>
    ...
    <div class="mt-8 pt-6 border-t border-gray-200 text-center">
        <div class="flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
            <div class="flex items-center mb-3 md:mb-0">
                ...
                <span>Terakhir diperbaharui: <?php echo e($user->updated_at->diffForHumans()); ?></span>
            </div>            <div class="flex space-x-4">
                <a href="<?php echo e(route('guru.settings.index')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        <?php if(session('success')): ?>
            window.showToast("<?php echo e(session('success')); ?>", 'success');
        <?php endif; ?>
        
        <?php if(session('error')): ?>
            window.showToast("<?php echo e(session('error')); ?>", 'error');
        <?php endif; ?>
        
        <?php if(session('status')): ?>
            window.showToast("<?php echo e(session('status')); ?>", 'info');
        <?php endif; ?>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/guru/profile/show_new.blade.php ENDPATH**/ ?>