<?php
// filepath: d:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\test_component.php
...
echo "Testing ActivityItem Component...\n\n";
...
$activity = Activity::create([
    ...
    'description' => 'Testing the ActivityItem component',
    'type' => 'system',
...
try {
    // Try rendering the component
    $html = View::make('components.activity-item', ['activity' => $activity, 'index' => 0])->render();
