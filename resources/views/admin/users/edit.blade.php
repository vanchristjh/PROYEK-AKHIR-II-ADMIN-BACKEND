...
@section('content')
    ...
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 mb-6 text-white relative overflow-hidden animate-fade-in">
        ...
        <div class="relative z-10">
            ...
            <p class="text-blue-100">Perbarui informasi untuk pengguna {{ $user->name }}.</p>
        </div>
    </div>
        ...
        <div class="p-6">
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="animate-fade-in">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group mb-5" id="classroom-container" style="{{ $user->role_id == 3 ? 'display: block;' : 'display: none;' }}">
                        ...
                        <div class="mt-1 relative">
                            <div class="flex items-center">
                                <div class="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center mr-4 avatar-preview">
                                    @if($user->avatar)
                                        <img src="{{ asset('storage/' . $user->avatar) }}" id="avatar-preview" class="w-full h-full object-cover rounded-full">
                                        <i class="fas fa-user text-gray-400 text-3xl hidden" id="avatar-icon"></i>
                                    @else
