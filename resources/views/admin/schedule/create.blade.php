...
@section('content')
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-lg p-6 mb-6 text-white relative overflow-hidden animate-fade-in">
        ...
        <div class="relative z-10">
            <h2 class="text-2xl font-bold mb-2">Tambah Jadwal Baru</h2>
            <p class="text-blue-100">Tambahkan jadwal baru untuk mata pelajaran, kelas, dan guru</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100/50 transform transition hover:shadow-md">
        <div class="p-6">
            ...
            <form action="{{ route('admin.schedule.store') }}" method="POST" class="animate-fade-in" id="scheduleForm">
                @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Load teachers based on subject selection
        ...
        subjectSelect.addEventListener('change', function() {
            ...
            if (subjectId) {
                // Here you can load teachers that teach this subject using AJAX
                // For now, we'll leave it with all teachers
            }
        });
    });
</script>
