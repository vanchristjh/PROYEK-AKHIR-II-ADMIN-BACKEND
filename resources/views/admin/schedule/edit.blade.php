...
@section('content')
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-lg p-6 mb-6 text-white relative overflow-hidden animate-fade-in">
        ...
        <div class="relative z-10">
            <h2 class="text-2xl font-bold mb-2">Edit Jadwal</h2>
            <p class="text-blue-100">Perbarui informasi jadwal</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100/50 transform transition hover:shadow-md">
        <div class="p-6">
            ...
            <form action="{{ route('admin.schedule.update', $schedule->id) }}" method="POST" class="animate-fade-in" id="scheduleForm">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="time" name="start_time" id="start_time" value="{{ old('start_time', date('H:i', strtotime($schedule->start_time))) }}" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-shadow duration-300" required>
                        </div>
                        @error('start_time')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="time" name="end_time" id="end_time" value="{{ old('end_time', date('H:i', strtotime($schedule->end_time))) }}" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-shadow duration-300" required>
                        </div>
                        @error('end_time')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
