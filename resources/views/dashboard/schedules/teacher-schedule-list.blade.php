...
@section('page-title', 'Daftar Jadwal Guru')
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                @php
                                    ...
                                    $sortedSchedules = $schedules->sortBy(function($schedule) use ($days) {
                                        return array_search($schedule->day_of_week, array_keys($days)) * 1000 + $schedule->start_time->format('Hi');
                                    });
                                @endphp
