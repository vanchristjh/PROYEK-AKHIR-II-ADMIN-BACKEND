                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('room') is-invalid @enderror" id="room" name="room" value="{{ old('room', $schedule->room) }}">
                                @error('room')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch mb-3">
                                ...
                                <div><small class="text-muted">Nonaktifkan jika jadwal ini sedang tidak berlaku.</small></div>
                            </div>
                            ...
                            <div id="notification_options" class="mb-3 ps-4 border-start" style="display: {{ old('enable_notification', $schedule->notification_enabled) ? 'block' : 'none' }}">
                            ...
                            <div class="mt-4 pt-3 border-top">
                                ...
                                <ul class="list-unstyled small text-muted">
                                    <li><i class="bx bx-calendar me-1"></i> Dibuat: {{ $schedule->created_at->format('d M Y H:i') }}</li>
                                    <li><i class="bx bx-edit me-1"></i> Diperbarui: {{ $schedule->updated_at->format('d M Y H:i') }}</li>
                                    <li><i class="bx bx-user me-1"></i> Dibuat oleh: {{ $schedule->creator ? $schedule->creator->name : 'System' }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
