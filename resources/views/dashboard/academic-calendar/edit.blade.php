                    ...
                    <div class="card border-0 shadow-sm mb-3">
                        <div class="card-body">
                            ...
                            <div class="mb-3" id="eventColorContainer">
                                ...
                                <input type="hidden" name="color" id="color_input" value="{{ old('color', $academicCalendar->color) }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Track form changes and form submission with animation
        ...
        formInputs.forEach(input => {
            input.addEventListener('change', function() {
                ...
                if (label && !label.querySelector('.bx-pencil')) {
        ...
        if (initialColor) {
            const initialOption = Array.from(colorOptions).find(opt => opt.getAttribute('data-color') === initialColor);
            if (initialOption) {
