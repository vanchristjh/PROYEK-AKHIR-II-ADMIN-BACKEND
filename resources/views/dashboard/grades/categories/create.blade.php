...
@section('page-title', 'Tambah Kategori Nilai')
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form action="{{ route('grade-categories.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="weight" name="weight" value="{{ old('weight', 0) }}" min="0" max="100" required>
