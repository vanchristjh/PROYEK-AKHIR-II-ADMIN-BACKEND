                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select @error('class_level') is-invalid @enderror" id="class_level" name="class_level">
                                        ...
                                        <option value="X" {{ old('class_level', $subject->class_level) == 'X' ? 'selected' : '' }}>Kelas X</option>
                                        <option value="XI" {{ old('class_level', $subject->class_level) == 'XI' ? 'selected' : '' }}>Kelas XI</option>
                                        <option value="XII" {{ old('class_level', $subject->class_level) == 'XII' ? 'selected' : '' }}>Kelas XII</option>
                                    </select>
                                    @error('class_level')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('credits') is-invalid @enderror" id="credits" name="credits" value="{{ old('credits', $subject->credits) }}" min="0">
                                    @error('credits')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('curriculum') is-invalid @enderror" id="curriculum" name="curriculum" value="{{ old('curriculum', $subject->curriculum) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('subject_type') is-invalid @enderror" id="subject_type" name="subject_type">
                                        ...
                                        <option value="Wajib" {{ old('subject_type', $subject->subject_type) == 'Wajib' ? 'selected' : '' }}>Mata Pelajaran Wajib</option>
                                        <option value="Muatan Lokal" {{ old('subject_type', $subject->subject_type) == 'Muatan Lokal' ? 'selected' : '' }}>Muatan Lokal</option>
                                        <option value="Peminatan" {{ old('subject_type', $subject->subject_type) == 'Peminatan' ? 'selected' : '' }}>Peminatan</option>
                                        <option value="Lintas Minat" {{ old('subject_type', $subject->subject_type) == 'Lintas Minat' ? 'selected' : '' }}>Lintas Minat</option>
                                    </select>
                                    @error('subject_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    @if($teachers->count() > 0)
                                        @foreach($teachers as $teacher)
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" id="teacher_{{ $teacher->id }}" name="teacher_ids[]" value="{{ $teacher->id }}" 
                                                    {{ in_array($teacher->id, old('teacher_ids', $assignedTeachers)) ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $subject->is_active) == '1' ? 'checked' : '' }}>
                            ...
                            <div class="mt-4 pt-3 border-top">
                                ...
                                <ul class="list-unstyled small text-muted">
                                    <li><i class="bx bx-calendar me-1"></i> Dibuat: {{ $subject->created_at->format('d M Y H:i') }}</li>
                                    <li><i class="bx bx-edit me-1"></i> Diperbarui: {{ $subject->updated_at->format('d M Y H:i') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
