...
@section('content')
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('guru.announcements.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
        <div class="p-4 bg-gray-50 border-b">
            <form action="{{ route('guru.announcements.index') }}" method="GET" class="flex flex-wrap items-end gap-4">
                ...
                @if(request()->anyFilled(['importance']))
                    <a href="{{ route('guru.announcements.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
    ...
    @component('components.announcements-list', ['announcements' => $announcements, 'routePrefix' => 'guru'])
    @endcomponent
@endsection
